...
import (
	...
	"github.com/trufflesecurity/trufflehog/v3/pkg/analyzer/analyzers/terraformcloud"
...
func Run(keyType string, secretInfo SecretInfo) {
	...
	case "terraformcloud":
		terraformcloud.AnalyzeAndPrintPermissions(secretInfo.Cfg, secretInfo.Parts["key"])
	}
}
